import 'package:tesys21_test/src/features/pokemon_details/data/models/ability_model.dart';
import 'package:tesys21_test/src/features/pokemon_details/data/models/move_model.dart';
import 'package:tesys21_test/src/features/pokemon_details/data/models/sprite_model.dart';
import 'package:tesys21_test/src/features/pokemon_details/data/models/stat_model.dart';
import 'package:tesys21_test/src/features/pokemon_details/data/models/type_model.dart';
...
class ShowPokemonResponseModel {
  ...
  factory ShowPokemonResponseModel.fromJson(Map<String, dynamic> map) {
    return ShowPokemonResponseModel(
      ...
      sprites: map["sprites"] == null ? null : SpriteModel.fromJson(map["sprites"])
    );
  }
}
